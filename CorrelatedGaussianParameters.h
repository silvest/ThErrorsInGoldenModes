...
private:
  ...
  TMatrixD *v; ///< The rotation matrix from the diagonalized parameters to the original parameters (was gslpp::matrix)
  TVectorD *e; ///< The diagonalized parameters (was gslpp::vector)
