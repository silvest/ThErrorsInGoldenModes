...
{
  cout << "constructor for BqDqDqbar_isospin called: inserting the experimental data" << endl;
...
void BqDqDqbar::DefineParameters(const string& channel) {
  ...
  if (channel == "Bddpdm") {
	...
	GetParameter("P1_GIM_dc_Bddpdm_re").SetUpperLimit(200.);
	GetParameter("P1_GIM_dc_Bddpdm_re").SetLowerLimit(-200.);
	GetParameter("P1_GIM_dc_Bddpdm_im").SetUpperLimit(200.);
	GetParameter("P1_GIM_dc_Bddpdm_im").SetLowerLimit(-200.);
	GetParameter("P3_GIM_dc_Bddmdp_re").SetUpperLimit(200.);
	GetParameter("P3_GIM_dc_Bddmdp_re").SetLowerLimit(-200.);
	GetParameter("P3_GIM_dc_Bddmdp_im").SetUpperLimit(200.);
	GetParameter("P3_GIM_dc_Bddmdp_im").SetLowerLimit(-200.);
	GetParameter("E1_dcc_Bddpdm_im").SetUpperLimit(0.0);
	GetParameter("E1_dcc_Bddpdm_im").SetLowerLimit(0.0);
    } 
        ...
        channelParameters[channel] = params;
        for (const auto& param : params) {
            AddParameter(param, -30., 35.);
        }
	GetParameter("E1_scc_Bddpsdm_re").SetUpperLimit(10.);
	GetParameter("E1_scc_Bddpsdm_re").SetLowerLimit(0.);
	GetParameter("E1_scc_Bddpsdm_im").SetLowerLimit(0.);
	GetParameter("E1_scc_Bddpsdm_im").SetUpperLimit(0.0);
	   ...
	   "A1_dcu_Bpdpd0b_im"
        ...
        channelParameters[channel] = params;
        AddParameter("A1_dcu_Bpdpd0b_re", -100., 100.);
	AddParameter("A1_dcu_Bpdpd0b_im", -100., 100.);
	...
	AddParameter("A1_scu_Bpdpsd0b_re", -290., 200.);
	AddParameter("A1_scu_Bpdpsd0b_im", -200., 200.);
	...
	GetParameter("A2_csc_Bsdmsdps_re").SetLowerLimit(-250.);
	GetParameter("E1_scc_Bsdpsdms_im").SetUpperLimit(0.0);
	GetParameter("E1_scc_Bsdpsdms_re").SetUpperLimit(400.);
	GetParameter("E1_scc_Bsdpsdms_im").SetLowerLimit(0.0);
	GetParameter("E1_scc_Bsdpsdms_re").SetLowerLimit(0.0);
	GetParameter("P1_GIM_sc_Bsdpsdms_im").SetUpperLimit(200.);
	GetParameter("P1_GIM_sc_Bsdpsdms_re").SetUpperLimit(200.);
	GetParameter("P3_GIM_sc_Bsdpsdms_im").SetUpperLimit(200.);
	GetParameter("P3_GIM_sc_Bsdpsdms_re").SetUpperLimit(200.);
	GetParameter("P1_GIM_sc_Bsdpsdms_im").SetLowerLimit(-200.);
	GetParameter("P1_GIM_sc_Bsdpsdms_re").SetLowerLimit(-200.);
	GetParameter("P3_GIM_sc_Bsdpsdms_im").SetLowerLimit(-200.);
	GetParameter("P3_GIM_sc_Bsdpsdms_re").SetLowerLimit(-200.);
    ...
    GetParameter("E1_dcc_Bsdpdms_im").SetLowerLimit(0.0);
    GetParameter("E1_dcc_Bsdpdms_im").SetUpperLimit(0.0);
    GetParameter("E1_dcc_Bsdpdms_re").SetLowerLimit(0.);
 ...
 void BqDqDqbar::compute_decay_amplitudes(const std::string& channel, bool conjugate) {
   ...
   // Get the CKM elements for the current channel, apply conjugation based on the 'conjugate' flag
	...
	- Vud*Vbu * (getPar("P1_GIM_dc_Bddpdm") + getPar("P3_GIM_dc_Bddmdp"));
      ...
      amp = Vcs*Vbc* (getPar("E1_scc_Bddpsdm"))
	...
	+ Vud*Vbu*(getPar("A1_dcu_Bpdpd0b") - getPar("P1_GIM_dc_Bddpdm"));
      ...
      amp = Vcs*Vbc* (getPar("E1_scc_Bddpsdm"))
	+ Vus*Vbu*(getPar("A1_scu_Bpdpsd0b") - getPar("P1_GIM_sc_Bddpsdm"));
        amplitudes[channel] = amp;
    } else if (channel == "Bsdpsdms") {
	...
	- Vus*Vbu * (getPar("P1_GIM_sc_Bsdpsdms") + getPar("P3_GIM_sc_Bsdpsdms"));
      ...
      amp = Vcd*Vbc*(getPar("E1_dcc_Bsdpdms"))
...
double BqDqDqbar::LogLikelihood(const std::vector<double>& parameters) {
    ...
    //ckm.sampleCKMParameters(ckmParams);  // Set the sampled CKM parameters (λ, A, ρ̄, η̄)
   ...
   for (const std::string& channel : channelNames) {
    ...
    // Construct A for SU(2) case by adding real parts of E1 and A2 terms
    if (channel == "Bddpdm") {
        A_real = getPar("E1_dcc_Bddpdm").real() + getPar("A2_cdc_Bddmdp").real();
	A_imag = getPar("A2_cdc_Bddmdp").imag();
	complex<double> A = getPar("E1_dcc_Bddpdm") + getPar("A2_cdc_Bddmdp");
	complex<double> B = getPar("P1_GIM_dc_Bddpdm") + getPar("P3_GIM_dc_Bddmdp");
	modA = abs(A);
	phaseA = arg(A);
	...
	phaseB = arg(B);
        ...
        A_real = getPar("E1_scc_Bddpsdm").real();
	A_imag = 0.;
	B_real = getPar("P1_GIM_sc_Bddpsdm").real();
	B_imag = getPar("P1_GIM_sc_Bddpsdm").imag();
	complex<double> B = getPar("P1_GIM_sc_Bddpsdm");
        complex<double> A = getPar("E1_scc_Bddpsdm");
	modA = abs(A);
	phaseA = arg(A);
	modB = abs(B);
	phaseB = arg(B);
	...
	complex<double> B = getPar("A1_dcu_Bpdpd0b") - getPar("P1_GIM_dc_Bddpdm");
	complex<double> A = getPar("E1_dcc_Bddpdm");
	modA = abs(A);
	phaseA = arg(A);
	modB = abs(B);
	phaseB = arg(B);
        ...
        A_real = getPar("E1_scc_Bddpsdm").real();
	A_imag = 0;
	B_real = getPar("A1_scu_Bpdpsd0b").real() - getPar("P1_GIM_sc_Bddpsdm").real();
	B_imag = getPar("A1_scu_Bpdpsd0b").imag() - getPar("P1_GIM_sc_Bddpsdm").imag();
	complex<double> B = getPar("A1_scu_Bpdpsd0b") - getPar("P1_GIM_sc_Bddpsdm");
	complex<double> A = getPar("E1_scc_Bddpsdm");
	modA = abs(A);
	phaseA = arg(A);
	modB = abs(B);
	phaseB = arg(B);
        ...
        A_real = getPar("E1_scc_Bsdpsdms").real() + getPar("A2_csc_Bsdmsdps").real();
	A_imag = getPar("A2_csc_Bsdmsdps").imag();
	B_real = getPar("P1_GIM_sc_Bsdpsdms").real() + getPar("P3_GIM_sc_Bsdpsdms").real();
	B_imag = getPar("P1_GIM_sc_Bsdpsdms").imag() + getPar("P3_GIM_sc_Bsdpsdms").imag();
	complex<double> B = getPar("P1_GIM_sc_Bsdpsdms") + getPar("P3_GIM_sc_Bsdpsdms");
	complex<double> A = getPar("E1_scc_Bsdpsdms") + getPar("A2_csc_Bsdmsdps");
	modA = abs(A);
	phaseA = arg(A);
	modB = abs(B);
	phaseB = arg(B);
        ...
        A_real = getPar("E1_dcc_Bsdpdms").real();
	A_imag = 0.;
	B_real = getPar("P1_GIM_dc_Bsdpdms").real();
	B_imag = getPar("P1_GIM_dc_Bsdpdms").imag();
	complex<double> B = getPar("P1_GIM_dc_Bsdpdms");
	complex<double> A = getPar("P1_GIM_dc_Bsdpdms");
	modA = abs(A);
	phaseA = arg(A);
	modB = abs(B);
	phaseB = arg(B);
